...
radiation-belt coordinate tools to the SPEDAS MCP:
...
Design contract (mirrors :mod:`spedas_mcp.analysis.coords` /
:mod:`spedas_mcp.analysis.spectral`, roadmap epic #5/#8):
...
def evaluate_magnetic_field(
    ...
    arrays never appear inline. Requires ``spedas-mcp[analysis]``.
    """
