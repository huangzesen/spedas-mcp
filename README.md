...
Unified SPEDAS-oriented MCP server that composes two focused XHelio building blocks:
...
1. Discover before fetching: `browse_observatories`, `load_observatory`, `browse_parameters`, or `list_spice_missions` first.
...
4. Treat CDAWeb downloads and SPICE kernel downloads as integration actions; make time ranges small by default.
...
- commands: `/spedas:cdaweb`, `/spedas:spice`, `/spedas:overview`;
